...
unset($__errorArgs, $__bag); ?>"
                    ...
                    <tr id="row">
                        <th scope="row" data-toggle="modal" data-target="#edit-<?php echo e($category->id); ?>"
                            style="cursor: pointer"><?php echo e($category->id); ?></th>
                        <td scope="row" data-toggle="modal" data-target="#edit-<?php echo e($category->id); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                           id="description"
                                           <?php if($errors->any()): ?> value="<?php echo e(old('description')); ?>"
                                           <?php endif; ?>  placeholder="<?php echo e(__('Ingrese la descripción de la nueva categoría (máximo 45 caracteres).')); ?>">
                                </div>
                                <div class="form-group text-right">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\smartecpos\resources\views/categories/show.blade.php ENDPATH**/ ?>